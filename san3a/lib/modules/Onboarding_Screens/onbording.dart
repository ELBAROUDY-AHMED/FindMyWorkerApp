...
List<OnboardingModel> tabs = [
  ...
  OnboardingModel(
    ...
    'chat with workers',
    'Take control of notifications, collaborate live or on your own time Get notified when worker ready.',
  ),
  OnboardingModel(
    'assets/animations/navigation.json',
    ' nearest place',
    'You can communicate with the worker closest to you and repent',
  ),
];
